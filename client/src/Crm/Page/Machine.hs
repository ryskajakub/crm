    ...
    B.grid $
      B.row $ [
        ...
        formRowCol 
          ...
          (div' (class' "col-md-3")
            let
              buttonLabel = case M.mileagePerYear machine' of
                mileagePerYear | mileagePerYear == 8760 -> "24/7"
                mileagePerYear | mileagePerYear == (MT. )
            -- BD.buttonDropdown buttonLabel elements
          ]
        ] ++ extraRow ++ [
