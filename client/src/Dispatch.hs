...
main' = do
  ...
  _ <- subscribeAndRead appVar' $ \appState -> let
    ...
    in case D.navigation appState of
      ...
      D.UpkeepHistory upkeeps' companyId deletable -> n $ upkeepHistory upkeeps' companyId deletable appVar' router
      ...
      D.MachineTypeEdit machineTypeId machinesCount machineType -> n $
        machineTypeForm router appVar' machineTypeId machineType machinesCount
